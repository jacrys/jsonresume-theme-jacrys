...
A theme for JSONResume, that forks from M. Adam Kendall's amazing work on [jsonresume-theme-kendall](https://github.com/LinuxBozo/jsonresume-theme-kendall), adding in pills for skills on work history.
